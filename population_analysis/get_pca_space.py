...
def get_pca_space(normalized_spikes, interval_ids, intervals_df):
    ...
    for block in block_bools:
        set_averages = get_set_averages(intervals_df, block, normalized_spikes, interval_ids)
...
def get_set_averages(intervals_df, bools, spikes, interval_ids, min_active=2):
